# Contributing to Go-Chan

Thanks for your interest! Go-Chan is an open-source project from Omega Mu Gamma Studio. Here's how to contribute effectively.
  ...
  "phases": [
    {
      "phase": 1,
      "title": "See It Work",
      "dialogue": "Explanation from Go-chan.",
      "code": "// Working Go code",
