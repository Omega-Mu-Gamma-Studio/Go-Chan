export const SHOP_ITEMS = [
  ...
  },
  {
    ...
    imageSrc: null,
    description: "Go-chan's signature look. Always with you.",
    isDefault: true,
  },
  {
    id: 'outfit-gamedev',
...
export const DOWNLOADABLE_WALLPAPERS = [
  {
    ...
    accent: '#b46eff',
    imageSrc: '/wallpapers/gochan-compile-time.png',
    fileName: 'gochan-compile-time.png',
  ...
  },
  {
    ...
    accent: '#7c6fff',
    imageSrc: '/wallpapers/gochan-the-stack.png',
    fileName: 'gochan-the-stack.png',
  ...
  },
  {
    ...
    accent: '#b46eff',
    imageSrc: '/wallpapers/gochan-rainy.png',
    fileName: 'gochan-rainy-commute.png',
  ...
  },
  {
    ...
    accent: '#ffcc6e',
    imageSrc: '/wallpapers/gochan-vacation-build.png',
    fileName: 'gochan-vacation-build.png',
...

  {
    ...
    accent: '#ffb7d5',
    imageSrc: '/wallpapers/gochan-sakura.png',
    fileName: 'gochan-cherry-blossom.png',
    description: 'Petals falling. The Go spec open on her lap. A perfect afternoon.',
    requiredLevel: 3,
    comingSoon: false,
  },

 {
    ...
    accent: '#ffcc6e',
    imageSrc: '/wallpapers/gochan-mountain-summit.png',
    fileName: 'gochan-mountain-summit.png',
    ...
    accent: '#ffaa55',
    imageSrc: '/wallpapers/gochan-autumn-library.png',
    fileName: 'gochan-autumn-library.png',
    description: 'Amber lamplight. Go textbooks. Leaves outside the window. The perfect session.',
    requiredLevel: 5,
    comingSoon: false,
  },
 
  {
    ...
    accent: '#7fff9b',
    imageSrc: '/wallpapers/gochan-rooftop-garden.png',
    fileName: 'gochan-rooftop-garden.png',
  ...
  },
  {
    ...
    accent: '#ff69b4',
    imageSrc: '/wallpapers/gochan-neon-arcade.png',
    fileName: 'gochan-neon-arcade.png',
  ...
  },
  {
    ...
    accent: '#ffccaa',
    imageSrc: '/wallpapers/gochan-shrine-steps.png',
    fileName: 'gochan-shrine-steps.png',
