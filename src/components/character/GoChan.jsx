...
/**
 * GoChan.jsx — Real sprite version
 *
...
const GoChan = () => {
  ...
  useEffect(() => {
    if (gochanExpression !== 'idle') {
      setDisplayExpression(gochanExpression);
          ...
          >
            <AnimatePresence mode="wait">
              <motion.img
                ...
                src={sprite.src}
                alt={`Go-chan ${displayExpression}`}
                className="gochan-sprite-img"
                style={sprite.blend ? { mixBlendMode: 'screen' } : {}}
                draggable={false}
