 ...
 *   - outfit, no art       → Go-chan's real "teaching" sprite with
...
const DownloadWallpaperCard = ({ item, level }) => {
  ...
  const handleDownload = () => {
    ...
    a.download = item.fileName || 'gochan-wallpaper.png';
    a.click();
    setDownloaded(true);
  ...
  return (
    <div className="shop-page">
      ...
      <section className="shop-section">
        ...
        <p className="shop-section-note">
          Go-chan's signature look — always available, can't be removed.
        </p>
        <div className="shop-grid">
          <motion.div
      ...
      <section className="shop-section">
        ...
        <p className="shop-section-note">
          Unlock outfits as you level up — equip them to change Go-chan's look across all 75 lessons.
        </p>
        <div className="shop-grid">
